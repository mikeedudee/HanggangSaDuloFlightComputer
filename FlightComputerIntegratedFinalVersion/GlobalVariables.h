...
static bool                             drogueDeployed                  = false;            // Flag for drogue deployment
static bool                             drogueFiring                    = false;            // Flag for drogue firing
static unsigned long                    drogueFireStart                 = 0;                // Timestamp for drogue firing  

static bool                             mainDeployed                    = false;            // Flag for main deployment
static bool                             mainFiring                      = false;            // Flag for main firing
static unsigned long                    mainFireStart                   = 0;                // Timestamp for main firing
...
static bool                             contingencyDrogueDeployed       = false;            // Flag for contingency drogue deployment
static bool                             contingencyDrogueFiring         = false;            // Flag for contingency drogue firing
static unsigned long                    contingencyDrogueFireStart      = 0;                // Timestamp for contingency drogue firing

static bool                             contingencyMainDeployed         = false;            // Flag for contingency main deployment
static bool                             contingencyMainFiring           = false;            // Flag for contingency main firing
static unsigned long                    contingencyMainFireStart        = 0;                // Timestamp for contingency main firing
